...
# 正则表达式来生成一个Pattern，以供re.search使用
...
# 现在我们在python中使用正则表达式将标记每个sqli或纯文本
# 此功能是功能提取
# 首先尝试词法分析
...
# G-Test Score 似然比
# https://en.wikipedia.org/wiki/G-test and https://en.wikipedia.org/wiki/Chi-squared_test
...
basedir = 'C:/Users/zhengfeng/Downloads/MachineLearning-master/Sql-Injection/source/trainingdata'
...
check_data = '-2020 union select python, machine, learning, study, version, 1--'
#check_data = '-1923'
